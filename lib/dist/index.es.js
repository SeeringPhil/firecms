...
import { styled as We, alpha as _n, darken as Lt } from "@mui/material/styles";
...
import Ls from "@mui/icons-material/Numbers";
import Kr from "@mui/icons-material/FormatListNumbered";
import Os from "@mui/icons-material/FormatQuote";
...
import Ll from "@mui/icons-material/ChevronLeft";
import Ol from "@mui/icons-material/ChevronRight";
...
function Br(e) {
  ...
  for (let l = 0; l < o.length; l++) {
    ...
    if (d) {
      ...
      const h = Ce(Ce(t).replace(c, "")), p = h.length > 0 ? h.split("/") : [];
      if (p.length > 0) {
        const f = p[0], g = u + "/" + f;
        if (s.push({
          type: "entity",
...
function ic({
  ...
  const s = Ve(), c = Ie().resolveAliasesFrom(e), d = i ? i[0] : void 0, A = i ? i[1] : void 0, u = re(), [h, p] = M([]), [f, g] = M(!1), [m, v] = M(), [b, x] = M(!1);
  return z(() => {
    g(!0);
    const y = async (I) => {
      ...
      g(!1), v(void 0), p(I), x(!a || I.length < a);
    }, k = (I) => {
      console.error("ERROR", I), g(!1), p([]), v(I);
    };
...
function Cr({
  ...
  const a = Ve(), s = Ie().resolveAliasesFrom(e), l = re(), [c, d] = M(), [A, u] = M(!0), [h, p] = M();
  return z(() => {
    u(!0);
    const f = async (m) => {
      ...
      Pn[`${s}/${t}`] = m, d(m), u(!1), p(void 0);
    }, g = (m) => {
      console.error("ERROR fetching entity", m), u(!1), d(void 0), p(m);
    };
    return t && i && Pn[`${s}/${t}`] ? (d(Pn[`${s}/${t}`]), u(!1), p(void 0), () => {
...
async function Gi({
  ...
  let h;
  const p = l.navigation.resolveAliasesFrom(t), f = e.callbacks;
  if (f?.onPreSave)
    try {
      const g = ke({
        collection: e,
...
const kr = () => Ye(xr), lc = (e) => {
  ...
  const A = () => navigator.clipboard !== void 0, u = w((b) => {
    ...
    navigator.clipboard.writeText(b).then(() => h(b)).catch((x) => {
      u(x), l(!1);
    });
  }, [u, h]), f = () => {
    ...
    (b = "copy", x) => {
      ...
      A() && !i && (x ? p(x) : y ? k ? (p(I.value), b === "cut" && (I.value = "")) : p(y.innerText) : u("Both the ref & text were undefined"));
    },
    [i, p, u]
  );
  return {
...
function xe({
  ...
  return r ? /* @__PURE__ */ n(Li, { title: r, children: a }) : a;
}
class ut {
  id;
  path;
...
function Fr(e) {
  const t = Oi(e), r = Object.keys(Xn), i = t % r.length;
  return Xn[r[i]];
}
function yn(e) {
...
function hc({
  ...
  if (!d)
    return null;
  let u = A;
  return (!u || !u.length) && (u = Object.keys(c), i && (u = u.slice(0, 3))), /* @__PURE__ */ n(zt, { size: "small", children: /* @__PURE__ */ n(Ut, { children: d && d.map((h, p) => /* @__PURE__ */ n(
    yt,
    {
      sx: {
...
function xc({
  ...
  return /* @__PURE__ */ n(yc, { className: $t.array, children: l && l.map(
    (h, p) => /* @__PURE__ */ E(
      ...
      {
        children: [
          /* @__PURE__ */ n("div", { className: $t.arrayItemBig, children: /* @__PURE__ */ n(ue, { children: h && /* @__PURE__ */ n(
            Re,
            {
              propertyKey: e,
              value: h[A],
              entity: a,
              property: s.resolvedProperties[p] ?? u[h[d]],
              size: c
            }
          ) }) }),
          p < l.length - 1 && /* @__PURE__ */ n(jt, {})
        ]
      },
      "preview_array_" + h + "_" + p
    )
  ) });
}
...
function Et({
  ...
  if (e.dataType === "string") {
    ...
    i.of && (Array.isArray(i.of) ? r = /* @__PURE__ */ E(Z, { children: [
      i.of.map((a, o) => Ln(a, o)),
      " "
    ] }) : i.of.dataType === "map" && i.of.properties ? r = Ic(i.of.properties, t, i.of.previewProperties) : i.of.dataType === "string" ? i.of.enumValues ? r = Fc() : i.of.storage ? r = Ln(i.of) : r = Sc() : r = Ln(i.of));
  } else
...
function Lc({
  ...
  if (z(() => {
    ...
    return null;
  const s = a?.metadata ? Oc(a?.metadata.contentType) : void 0, l = s?.startsWith("image") ? "image" : s?.startsWith("video") ? "video" : s?.startsWith("audio") ? "audio" : "file";
  return a ? /* @__PURE__ */ n(
    Kn,
    {
      previewType: l,
...
function Uc({
  ...
  const {
    ...
    () => Aa(p, s.fields, r, i === "small" || i === "regular" ? 3 : 1),
    [r, p, i]
  );
  let g;
  function m(v, b) {
  ...
  return p ? (t ? t instanceof ut ? A && !A.values ? g = m("Reference does not exist", t.path) : g = /* @__PURE__ */ E(Z, { children: [
    /* @__PURE__ */ E(B, { sx: {
      display: "flex",
      flexDirection: "column",
      flexGrow: 1,
...
function Ze(e, t) {
  const r = On(e), i = r ? Object.assign({}, e) : e;
  return r && On(t) && Object.keys(t).forEach((a) => {
    On(t[a]) ? a in e ? i[a] = Ze(e[a], t[a]) : Object.assign(i, { [a]: t[a] }) : Object.assign(i, { [a]: t[a] });
  }), i;
}
function Bt(e, t) {
  if (typeof e == "object") {
...
const Jc = /[A-Z]{2,}(?=[A-Z][a-z]+[0-9]*|\b)|[A-Z]?[a-z]+[0-9]*|[A-Z]|[0-9]+/g, Lg = (e) => {
  const t = e.match(Jc);
  return t ? t.map((r) => r.toLowerCase()).join("-") : "";
}, Zc = /[A-Z]{2,}(?=[A-Z][a-z]+[0-9]*|\b)|[A-Z]?[a-z]+[0-9]*|[A-Z]|[0-9]+/g, Og = (e) => {
  const t = e.match(Zc);
      ...
      children: [
        ...
        /* @__PURE__ */ n(
          Je,
          {
            ...
            onChange: (p) => {
              const f = p.target.value, g = f ? c.dataType === "number" ? parseFloat(f) : f : null;
              return r(g);
            },
            renderValue: (p) => /* @__PURE__ */ n(
              Oe,
              {
                enumKey: p,
                enumValues: u,
      ...
      children: [
        ...
        /* @__PURE__ */ n(
          Je,
          {
            ...
            onChange: (p) => {
              let f;
              return d?.dataType === "number" ? f = p.target.value ? p.target.value.map((g) => parseFloat(g)) : [] : f = p.target.value, r(
                f
              );
            },
            renderValue: (p) => /* @__PURE__ */ n(
            ...
            children: yn(A).map((p) => {
              const f = p.id, g = h && t.map((m) => m.toString()).includes(f.toString());
              return /* @__PURE__ */ E(
                Ge,
                {
                  value: f,
...
function ed({
  ...
  const A = s.expanded === void 0 ? !0 : s.expanded, [u, h] = Q.useState(!1), p = t && Array.isArray(t) ? t.map((I) => I.id) : [];
  Te({
    property: s,
    value: t,
    setValue: c
...
function qi({
  ...
  const u = d?.metadata, h = A ? "small" : "regular", p = d?.imageCompression, f = (A ? i ?? [] : i ? [i] : []).map((C) => ({
    id: Vn(),
  ...
  const x = w(async (C) => {
    ...
    const $ = R.filter((O) => !!O.storagePathOrDownloadUrl).map((O) => O.storagePathOrDownloadUrl);
    c(A ? $ : $ ? $[0] : null);
    ...
    if (A)
      S = [
        ...v,
        ...await Promise.all(C.map(async (D) => (p && tr(D) && (D = await Do(D, p)), {
          id: Vn(),
          file: D,
          fileName: await x(D),
          metadata: u,
...
function Xi({
  ...
  const s = _t(), l = rt(), [c, d] = Q.useState(), [A, u] = Q.useState(!1), h = Q.useRef(!1), p = Q.useRef(!1), f = w((g, m) => {
    p.current || (p.current = !0, d(void 0), u(!0), s.uploadFile({
      file: g,
      fileName: m,
      path: e,
      metadata: r
    }).then(async ({ path: v }) => {
      console.debug("Upload successful"), await i(v, t, r), h.current && u(!1);
    }).catch((v) => {
      console.error("Upload error", v), h.current && (d(v), u(!1), l.open({
        type: "error",
  ...
  return Q.useEffect(() => (h.current = !0, t.file && f(t.file, t.fileName), () => {
    h.current = !1;
...
function Qo({
  ...
  const u = _t(), h = Jt(l) || !!l.disabled || A, {
    internalValue: p,
    setInternalValue: f,
    onFilesAdded: g,
    storage: m,
...
function ad({
  ...
  const p = A?.metadata, f = o ? "small" : "regular", g = w((y, k) => {
    if (!o)
      return;
    const I = [...r], C = I[y];
...
function Mt({
  ...
  const h = w(() => {
    r(null);
  }, [r]), p = Boolean(u), g = (t ?? (l.dataType === "string" ? "" : t === 0 ? 0 : "")) === 1 / 0, m = !g && l.dataType === "number" ? "number" : void 0, v = w((b) => {
    if (!b)
      r(
        null
      );
...
const sd = Q.forwardRef(function({
  ...
  return /* @__PURE__ */ n(Z, { children: /* @__PURE__ */ E(we, { fullWidth: !0, children: [
    /* @__PURE__ */ n(
      ...
      {
        sx: (g) => ({
          color: p ? g.palette.primary.main : g.palette.text.secondary,
          ...
          transition: "background-color 200ms cubic-bezier(0.0, 0, 0.2, 1) 0ms",
          "&::before": {
            borderBottom: p ? g.palette.mode === "light" ? "1px solid rgba(255, 255, 255, 0.7)" : "1px solid rgba(0, 0, 0, 0.87)" : g.palette.mode === "light" ? "1px solid rgba(0, 0, 0, 0.42)" : "1px solid rgba(255, 255, 255, 0.7)",
            left: 0,
            bottom: 0,
            content: '"\\00a0"',
            position: "absolute",
...
function ld({
  ...
  const h = w(() => {
    r(null);
  }, [r]), p = c.mode === void 0 || c.mode === "date_time" ? wr : br;
...
function dd({
  ...
  const p = At(), f = Ie(), g = ie(() => f.getCollection(c.path), [c.path, f]);
  if (!g)
  ...
  const m = c.path, v = t && t instanceof ut, {
    ...
    R.stopPropagation(), b && (h.onAnalyticsEvent?.("entity_click_from_reference", {
      path: b.path,
      entityId: b.id
    }), p.open({
      entityId: b.id,
    ...
    if (!R)
      ...
      O = /* @__PURE__ */ n(de, { title: t && t.path, children: /* @__PURE__ */ E(
        B,
        {
          display: "flex",
          alignItems: "center",
      ...
      const K = Aa(R, h.fields, c.previewProperties, 3);
      O = /* @__PURE__ */ n(
        B,
        {
          display: "flex",
...
const Ad = function({
  ...
  if (Jt(p))
    ...
    typeof p.Field == "function" && (h = p.Field);
  else {
    const f = Pr(p);
    if (!f)
  ...
  return /* @__PURE__ */ n("div", { children: `Currently the field ${p.dataType} is not supported` });
...
function ud({
  ...
  const h = r.customProps, p = u.field.value, f = u.meta.initialValue, g = Zn(u.form.errors, t), m = Zn(u.form.touched, t), v = g && (u.form.submitCount > 0 || r.validation?.unique) && (!Array.isArray(g) || !!g.filter((y) => !!y).length), b = u.form.isSubmitting;
...
function fd({
  ...
  const h = a.pickOnlySomeKeys || !1, p = (a.expanded === void 0 ? !0 : a.expanded) || d;
  if (!a.properties)
    throw Error(`You need to specify a 'properties' prop (or specify a custom field) in your map property ${e}`);
  let f;
  h ? t ? f = jc(
...
function gd({
  ...
  const p = l.expanded === void 0 ? !0 : l.expanded, f = l.of, [g, m] = M();
  Te({
    property: l,
    value: t,
    setValue: o
...
function hd({
  ...
  const p = l.expanded === void 0 ? !0 : l.expanded;
  Te({
    property: l,
    value: t,
    setValue: o
  ...
  return /* @__PURE__ */ E(we, { fullWidth: !0, error: i, children: [
    !s && /* @__PURE__ */ n(Zt, { expanded: p, title: v, children: b }),
    s && b,
    c && /* @__PURE__ */ n(De, { property: l }),
    i && typeof r == "string" && /* @__PURE__ */ n(Ee, { children: r })
  ] });
...
function pd({
  ...
  const h = A ? o[A] : void 0, p = Object.entries(o).map(([v, b]) => ({ id: v, label: b.name ?? v })), f = `${e}[${i}]`, g = `${e}[${a}]`, m = h ? {
    propertyKey: g,
    property: h,
    context: c,
    autoFocus: s,
    tableMode: !1,
    shouldAlwaysRerender: h.fromBuilder
  } : void 0;
...
function bd({
  ...
  const [p, f] = Q.useState(t), g = an(p), m = an(t);
  return z(() => {
    f(t);
  }, [t]), z(() => {
    g !== m && r(g);
...
const Fd = ({ containerRef: e }) => {
  ...
  const l = o?.getCollectionConfig(t), c = Bt(l, "properties"), d = gn(e.properties), A = i ?? d, u = a ?? i ?? d, h = Object.entries(e.properties).map(([g, m]) => ({
    [g]: $e({
      propertyOrBuilder: m,
      values: A,
      previousValues: u,
  ...
  })).filter((g) => g !== null).reduce((g, m) => ({ ...g, ...m }), {}), p = Ze(h, c), f = Object.entries(p).filter(([g, m]) => Boolean(m?.dataType)).map(([g, m]) => ({ [g]: m })).reduce((g, m) => ({ ...g, ...m }), {});
  return {
    ...e,
    properties: f,
...
function Qd({
  ...
  return /* @__PURE__ */ Pl(
    ...
    c && /* @__PURE__ */ E(Z, { children: [
      /* @__PURE__ */ n(It, { id: "id-label", children: p.label }),
      /* @__PURE__ */ n(
        Je,
        {
          labelId: "id-label",
...
const Td = function({
  ...
  const d = re(), A = Ve(), u = ie(() => ke({
    ...
    values: a?.values,
    fields: d.fields
  }), [a?.values, i, r]), h = (t === "new" || t === "copy") && Boolean(u.customId) && u.customId !== "optional", p = ie(() => t === "new" || t === "copy" ? h ? void 0 : A.generateEntityId(r) : a?.id, []), f = he(!1), g = ie(() => {
    const L = u.properties;
    if ((t === "existing" || t === "copy") && a)
      return a.values ?? gn(L);
    if (t === "new")
      return gn(L);
    throw console.error({
      status: t,
  ...
  }, [t, u, a]), [m, v] = Q.useState(p), [b, x] = Q.useState(!1), [y, k] = Q.useState(), [I, C] = M(a?.values ?? g), [S, D] = M(I), P = (L) => {
    D(L), c && c(L);
  }, R = ie(() => ke({
    collection: i,
    path: r,
  ...
  const O = ie(() => I && t === "existing" ? Object.entries(R.properties).map(([L, F]) => {
    if (Tr(F))
      return {};
    const G = I[L], U = g[L];
    return Ae(G, U) ? {} : { [L]: U };
  }).reduce((L, F) => ({ ...L, ...F }), {}) : {}, [g, R.properties, I, t]), K = w((L, F) => {
    if (h && !m) {
    ...
    o?.({
      ...
      d.onAnalyticsEvent?.(U, { path: r }), C(L), F.resetForm({
        values: L,
        submitCount: 0,
        touched: {}
      });
  ...
  return /* @__PURE__ */ n(
    ci,
    {
      ...
      validateOnMount: !0,
      validationSchema: W,
      validate: (L) => console.debug("Validating", L),
      onReset: () => s && s(),
      children: (L) => /* @__PURE__ */ n(Z, { children: /* @__PURE__ */ E(
        B,
        {
          sx: (F) => ({
...
function Pd({
  ...
  }) }), k = u || !b && h === "existing", I = Q.createRef();
  return /* @__PURE__ */ E(
    di,
    {
      onSubmit: p,
        ...
        /* @__PURE__ */ E(gt, { position: "absolute", children: [
          ...
          /* @__PURE__ */ E(
            ae,
            {
              ...
              children: [
                h === "existing" && "Save and close",
                h === "copy" && "Create copy and close",
                h === "new" && "Create and close"
              ]
            }
          )
        ] })
...
function $d({
  ...
  return /* @__PURE__ */ E(we, { fullWidth: !0, error: i, children: [
    !s && /* @__PURE__ */ n(Zt, { expanded: p, title: f, children: g }),
    s && g,
    c && /* @__PURE__ */ n(De, { property: l }),
    i && typeof r == "string" && /* @__PURE__ */ n(Ee, { children: r })
  ] });
...
function Ud(e) {
  ...
  return /* @__PURE__ */ n(
    Xo,
    {
      ...
      onBlur: o,
      onChange: (p) => {
        const f = p.target.value.replace(",", ".");
        f.length === 0 && d(null), (h.test(f) || f.startsWith("-")) && d(f);
      }
    }
  );
}
...
function $o(e) {
  const {
    ...
    disabled: d,
    forceFilter: A
  } = e, [u, h] = M(!1), p = w(() => h(!0), []), f = w(() => h(!1), []), m = Ie().getCollection(o);
  if (!m)
...
function Xd({
  ...
  ), { ...P } = k(), R = s ? "Drag 'n' drop some files here, or click here to edit" : "Drag 'n' drop a file here, or click here edit", $ = s ? e.of : e, O = ie(() => xt(m), [m]), K = Be();
  return /* @__PURE__ */ E(
    B,
    {
      ...P,
      ...
      children: [
        ...
        r.map((V, W) => {
          let L;
          return V.storagePathOrDownloadUrl ? L = /* @__PURE__ */ n(
            Kd,
            {
              property: $,
...
const tA = Bi("div", {})(({
  ...
  function({
    ...
    const [b, x] = yi(), y = Be(), k = Q.createRef(), [I, C] = M(!1), S = ie(() => Ct(i), [i]), [D, P] = M(!1), [R, $] = M(l), O = !o && d, K = Q.createRef();
    z(() => {
    ...
    const j = !O && a;
    let se;
    R ? se = `2px solid ${y.palette.success.light}` : j ? se = "2px solid #5E9ED6" : O ? se = `2px solid ${y.palette.error.light} !important` : se = "2px solid transparent";
...
const oA = Q.memo(
  function({
    ...
    const p = Ve(), f = re(), {
      ...
      setPopupCell: y,
      selectedEntityIds: k
    } = QA(), I = k?.includes(u.id) ?? !1, C = v?.columnIndex === r && v?.entity.id === u.id, [S, D] = M(a), P = he(a), [R, $] = M(), [O, K] = M(!1), V = w(() => {
      K(!0), setTimeout(() => {
        K(!1);
      }, 100);
    }, []), W = Boolean(o.Field), L = Boolean(o.Preview), F = Jt(o), G = typeof o.disabled == "object" ? o.disabled.disabledMessage : void 0, U = Boolean(o.disabled), j = ie(() => Vt({
      property: o,
      entityId: u.id,
      customFieldValidator: i,
      name: t
...
function aA({
  ...
  const s = (A) => {
    if (A.button !== 0 || !e.current || A.defaultPrevented)
      return;
    const { x: u, y: h } = e.current.getBoundingClientRect();
    a = A.screenX - u, o = A.screenY - h, document.addEventListener("mousemove", c), document.addEventListener("mouseup", l);
  }, l = (A) => {
...
function dA({
  ...
  const u = Ve(), h = re(), [p, f] = Q.useState(), [g, m] = M(), [v, b] = M(t?.values), x = a ? ke({
    collection: a,
    path: o,
    values: v,
    entityId: t?.id,
  ...
  const C = w(() => {
    ...
    return {
      ...
      y: Math.max(0, Math.min(L, y.height - F.height))
    };
  }, [y]), D = w((W) => {
  ...
  }, [o, i, x, t]), R = w(() => D(g), [g, D]), $ = w((W) => D(W), [D]), O = async (W) => (f(null), a && t && A && i ? A({
    value: W[i],
    propertyKey: i,
    entity: t,
    setError: f,
  ...
  const K = t && /* @__PURE__ */ E(B, { sx: (W) => ({
    ...
    /* @__PURE__ */ n(
      ci,
      {
        ...
        onSubmit: (W, L) => {
          O(W).then(() => c()).finally(() => L.setSubmitting(!1));
        },
        children: ({
          handleChange: W,
          values: L,
    ...
    p && /* @__PURE__ */ n(X, { color: "error", children: p.message })
  ] }), V = /* @__PURE__ */ E(
    B,
    {
      sx: (W) => ({
...
function uA({
  ...
  const [c, d] = t || [l[0], void 0], [A, u] = M(c), [h, p] = M(d);
  function f(m, v) {
    let b = v;
    const x = zn.includes(A), y = zn.includes(m);
    x !== y && (b = y ? typeof v == "string" || typeof v == "number" ? [v] : [] : ""), typeof b == "number" && isNaN(b) && (b = void 0), u(m), p(b);
  ...
  return /* @__PURE__ */ E(B, { display: "flex", width: 340, alignItems: "center", children: [
    ...
    h !== void 0 && /* @__PURE__ */ n(B, { ml: 1, children: /* @__PURE__ */ n(
      ne,
      {
...
function pA({
  ...
  const s = t ? ["array-contains"] : ["==", "!=", ">", "<", ">=", "<="], [l, c] = i || [s[0], void 0], [d, A] = M(l), [u, h] = M(c);
  function p(g, m) {
    let v = m;
    const b = Lo.includes(d), x = Lo.includes(g);
    b !== x && (v = x ? m ? [m] : [] : ""), A(g), h(v === null ? void 0 : v);
...
const mA = Q.memo(
  function({
    ...
    const A = he(null), [u, h] = M(!1), [p, f] = Q.useState(!1), g = w((k) => {
      f(!0);
    }, []), m = w(() => {
      f(!1);
    }, []), v = w((k) => {
      ...
      /* @__PURE__ */ E(
        oe,
        {
          ...
          children: [
            ...
            c.sortable && (a || y || p) && /* @__PURE__ */ n(oe, { item: !0, children: /* @__PURE__ */ n(
              Nr,
              {
                color: "secondary",
                variant: "dot",
...
const Oo = ({
  ...
  const c = e.map(() => La()), [d, A] = M(-1), u = w((x, y, k) => {
...
const EA = Oa(({
  ...
  function({
    ...
    const O = w(() => {
      ...
      me && d && !d(me, fe) && A && A(void 0), r && r(), f && f(fe), O();
    }, [d, x, A, r, f, O, b]), V = w(() => {
      C.current = 0, f && f(void 0);
    }, [f]), W = Math.max((t?.length ?? 0) * Ct(a) - D.height, 0), L = w((J) => {
    ...
    ), [h?.message]), j = w(() => g ? /* @__PURE__ */ n(kt, {}) : /* @__PURE__ */ E(
      B,
      {
        display: "flex",
        flexDirection: "column",
        ...
        children: [
          ...
          /* @__PURE__ */ n(X, { children: p })
        ]
      }
    ), [p, g]), se = !g && (t?.length ?? 0) === 0, _ = h ? U() : se ? j() : void 0;
    return /* @__PURE__ */ n(
      B,
      {
        ref: S,
...
function Or({
  ...
  const A = Be(), u = Le(A.breakpoints.up("md")), h = Boolean(c), p = Boolean(l), f = Boolean(d), [g, m] = Q.useState(null), v = w((C) => {
  ...
  return /* @__PURE__ */ E(
    B,
    {
      ...
      children: [
        (h || f || a) && /* @__PURE__ */ E(B, { sx: {
          minWidth: 138,
          display: "flex",
          justifyContent: "center"
        }, children: [
          h && /* @__PURE__ */ n(de, { title: `Edit ${e.id}`, children: /* @__PURE__ */ n(
            ne,
            {
              onClick: (C) => {
          ...
          (p || f) && /* @__PURE__ */ E(
            qa,
            {
              ...
              children: [
                ...
                p && /* @__PURE__ */ E(Ge, { onClick: k, children: [
...
function kA({ onTextSearch: e }) {
  ...
  return /* @__PURE__ */ n(we, { children: /* @__PURE__ */ E(B, { sx: (l) => ({
    ...
    backgroundColor: l.palette.mode === "light" ? _n(l.palette.common.black, 0.05) : Lt(l.palette.background.default, 0.2),
    "&:hover": {
      backgroundColor: l.palette.mode === "light" ? _n(l.palette.common.black, 0.1) : Lt(l.palette.background.default, 0.3)
    },
...
const IA = We(Ei)(({ theme: e }) => ({
  ...
  "& .MuiInputBase-input": {
    borderRadius: 4,
    position: "relative",
    backgroundColor: e.palette.mode === "light" ? _n(e.palette.common.black, 0.05) : Lt(e.palette.background.default, 0.2),
    fontSize: 14,
  ...
  return /* @__PURE__ */ n(
    Dl,
    {
      ...
      sx: (t) => ({
        ...
        "&:hover": {
          backgroundColor: Lt(t.palette.background.default, 0.1)
        },
        "&:focus": {
          backgroundColor: Lt(t.palette.background.default, 0.2),
...
function RA(e) {
  const t = Be(), r = Le(t.breakpoints.up("md")), i = !e.forceFilter && e.filterIsSet && /* @__PURE__ */ n(de, { title: "Clear filter", children: /* @__PURE__ */ n(
    ne,
    {
...
const DA = {}, ha = Q.createContext(DA), QA = () => Ye(ha), pa = Q.memo(
  function({
    ...
    tableController: {
      ...
      pageSize: V,
      paginationEnabled: W,
      checkFilterCombination: L
    },
    ...F
  }) {
    const G = Be(), U = Le(G.breakpoints.up("md")), j = Boolean(o), se = A?.selectedEntities?.length > 0 ? A?.selectedEntities : u, _ = Q.useRef(Math.random().toString(36)), J = re(), N = Ve(), ee = At(), T = ie(() => ke({
      collection: F,
      path: t,
      fields: J.fields
...
function YA({
  ...
  const d = Ve(), A = rt(), [u, h] = M(!1), [p, f] = Q.useState(), [g, m] = Q.useState(), v = re();
  Q.useEffect(() => {
    if (e) {
  ...
  const b = ie(() => ke({
    ...
    p && (h(!0), g ? Promise.all(p.map(S)).then(($) => {
      h(!1), s && p && s(l, p), $.every(Boolean) ? A.open({
        type: "success",
      ...
      h(!1), $ && (o && p && o(l, p), A.open({
        type: "success",
        message: `${b.singularName ?? b.name} deleted`
      }), r());
    }));
  }, [p, g, S, s, l, r, A, b.name, o]);
  let P;
  if (p && g)
...
function jA({
  ...
  const i = re(), a = Ve(), s = Ie().resolveAliasesFrom(t), l = Q.useMemo(() => ke({
    ...
    path: s,
    fields: i.fields
  }), [e, s]), c = he(), d = he(), [A, u] = Q.useState(!1), [h, p] = Q.useState(), [f, g] = Q.useState(!1), [m, v] = Q.useState(!1), [b, x] = Q.useState(!1), y = w(() => {
    x(!0);
  }, [x]), k = w(() => {
    x(!1);
  }, [x]), I = w((R, $, O, K, V) => {
    ...
    c.current = R;
    const O = await C(R);
    d.current = O, p(void 0), $ && (I(R, O, l, s, r), k());
  }, [l, I, r, C, m, k, s]);
  z(() => {
...
function NA({
  ...
  const c = re(), d = Ft(), A = Be(), u = Le(A.breakpoints.up("md")), h = s.selectedEntities, p = Lr(e, d, tt(o), null) && t && (u ? /* @__PURE__ */ E(
    ae,
    {
      onClick: t,
...
function xa({
  ...
  const {
    ...
    initialSort: s,
    forceFilter: l
  } = t, c = t.pagination === void 0 || Boolean(t.pagination), d = typeof t.pagination == "number" ? t.pagination : JA, [A, u] = Q.useState(), [h, p] = Q.useState(c ? d : void 0), f = w((R, $) => i(R, $, a), [a]), g = ie(() => {
    if (s && l && !f(l, s)) {
...
const Ba = Q.memo(
  function({
    ...
    const a = At(), o = Ft(), s = Pi(), l = re(), c = ie(() => {
      ...
      return T ? Ze(i, T) : i;
    }, [i, t, s]), d = Be(), [A, u] = M(void 0), [h, p] = Q.useState(void 0), f = w(() => {
      const T = A;
      setTimeout(() => {
        T === A && u(void 0);
      }, 2400);
    ...
    ] }) }), [d, c.description, c.name, t, j, x]), _ = Lr(c, o, tt(t), null), J = w((T) => {
...
function qA({
  ...
  const c = Yr(), d = At(), A = Ie(), u = re(), h = A.resolveAliasesFrom(o), p = Ve(), [f, g] = M([]), m = Ca();
  z(() => {
    let S = !1;
    return s && a ? Promise.all(
      s.map((D) => p.fetchEntity({
        path: h,
        entityId: D,
        collection: a
      }))
  ...
  const v = w(() => {
    ...
    const $ = m.selectedEntities, O = $ && $.map((K) => K.id).indexOf(S.id) > -1;
    return /* @__PURE__ */ n(
      Or,
      {
        width: P,
...
function XA({
  ...
  const a = Ft(), o = Be(), s = Le(o.breakpoints.up("md")), l = Lr(e, a, tt(t), null) && i && (s ? /* @__PURE__ */ E(
    ae,
    {
      onClick: i,
      startIcon: /* @__PURE__ */ n(cn, {}),
...
function KA({
  ...
  if (d.plugins && r) {
    ...
    A = /* @__PURE__ */ n(Z, { children: d.plugins.map((h, p) => h.homePage?.CollectionActions ? /* @__PURE__ */ n(
              ...
              oe,
              {
                ...
                children: /* @__PURE__ */ n(
                  KA,
                  {
                    ...u,
                    onClick: () => {
                      const h = u.type === "collection" ? "home_navigate_to_collection" : u.type === "view" ? "home_navigate_to_view" : "unmapped_event";
                      t.onAnalyticsEvent?.(h, { path: u.path });
                    }
                  }
                )
              },
...
const nu = Q.memo(
  function({
    ...
    const A = Be(), u = Le(A.breakpoints.up("lg")), h = he(!u), p = typeof l == "number" ? `${l}px` : l ?? dn, f = Ve(), g = Yr(), m = At(), v = rt(), b = re(), x = Ft(), [y, k] = M(a ? "copy" : r ? "existing" : "new"), [I, C] = M(r), S = he(void 0), D = S.current, P = (o.subcollections ?? []).filter((Y) => !Y.hideFromNavigation), R = P?.length ?? 0, $ = o.views, O = $?.length ?? 0, K = O > 0 || R > 0, V = _i(o), W = !i && u && V, [L, F] = Q.useState(W ? 0 : -1), G = L === -1 || u, {
      entity: U,
      dataLoading: j,
      dataLoadingError: se
    } = Cr({
...
const iu = (e, t) => {
  const r = Nt(), i = he(!1), a = Be(), o = Le(a.breakpoints.up("lg")), s = Le(a.breakpoints.down("sm"));
  z(() => {
    if (!e.loading && !i.current) {
      if (e.isUrlCollectionPath(r.pathname)) {
        const A = r.hash === `#${Ia}`, u = e.urlPathToDataPath(r.pathname), h = au(u, e.collections, A);
        t.replace(h.map((p) => jn(p, e, s)));
      }
      i.current = !0;
    }
  }, [r, e, t, s]);
...
function su({
  ...
  const d = Nt(), [A, u] = M(), [h, p] = M(), [f, g] = M(!1), [m, v] = M(void 0), [b, x] = M(!0), [y, k] = M(void 0), I = Ce(e), C = Ce(t), S = I ? `/${I}` : "/", D = I ? `/${I}/${C}` : `/${C}`, P = w(
    (j) => I ? `/${I}/${tn(j)}` : `/${tn(j)}`,
    [I]
  ), R = w(
    (j) => `${Ce(t)}/${tn(j)}`,
...
function du() {
  ...
  z(() => {
    const p = (e.state?.panels ?? []).map((f) => o.current[f]).filter((f) => Boolean(f));
    Ae(a.current.map((f) => f.key), p.map((f) => f.key)) || l(p);
  }, [e]);
  const c = w(() => {
    if (r.length === 0)
      return;
    ...
    const p = e.state?.base_location ?? e, f = [...r, ...h];
    l(f), h.forEach((g) => {
      g.urlPath && t(
        g.urlPath,
        {
    ...
    const p = e.state?.base_location ?? e, f = [...r.slice(0, -h.length), ...h];
    l(f), h.forEach((g) => {
      g.urlPath && t(
        g.urlPath,
        {
...
function uu(e) {
  const t = kr(), {
    ...
    onAnalyticsEvent: m,
    fields: v
  } = e, b = p ?? "/", x = f ?? Au, y = c ? Jo[c] : void 0, k = su({
    basePath: b,
...
function gu({
  ...
  const {
    navigationEntries: d,
    groups: A
  } = i.topLevelNavigation, u = Object.values(d).filter((f) => !f.group), h = w((f) => e ? /* @__PURE__ */ n(B, { pt: 2, pl: 2, pr: 2, pb: 0.5, sx: {
    display: "flex",
    flexDirection: "row",
    alignItems: "center"
  }, children: /* @__PURE__ */ n(
  ...
  ) }) : /* @__PURE__ */ n(B, { sx: { height: 16 } }), [e]), p = (f) => {
...
const hu = function({
  ...
  const a = Ir(), { breadcrumbs: o } = a, s = Ft(), { mode: l, toggleMode: c } = kr(), d = Be(), A = Le(d.breakpoints.up("md")), u = s.user?.displayName ? s.user.displayName[0].toUpperCase() : s.user?.email ? s.user.email[0].toUpperCase() : "A";
  return /* @__PURE__ */ n(
    B,
    {
      sx: {
  ...
  function(t) {
    const {
      ...
      Drawer: c
    } = t, d = Be(), A = Le(d.breakpoints.up("md")), u = Ie(), h = mu(), [p, f] = Q.useState(!1), g = c || gu, m = w(() => {
      f(!1);
    }, []);
    return /* @__PURE__ */ E(B, { sx: {
      display: "flex",
      ...
      /* @__PURE__ */ n(
        wu,
        {
          ...
          drawerUrlLabel: s,
          setDrawerOpen: f,
          children: /* @__PURE__ */ n("nav", { children: u.loading ? /* @__PURE__ */ n(kt, {}) : /* @__PURE__ */ n(
            g,
            {
              drawerOpen: p,
              closeDrawer: m
...
function wu(e) {
  const t = re(), r = Be(), i = Le(r.breakpoints.up("md")), {
    open: a,
    logo: o,
    setDrawerOpen: s,
        ...
        children: [
          /* @__PURE__ */ n(
            fo,
            {
              ...
              children: r.direction === "rtl" ? /* @__PURE__ */ n(Ol, {}) : /* @__PURE__ */ n(Ll, {})
            }
          ),
          /* @__PURE__ */ n(oi, { sx: {
            position: "absolute",
          ...
          /* @__PURE__ */ n(
            Gt,
            {
              ...
              to: ".",
              sx: (h) => ({
                transition: h.transitions.create(["padding"], {
                  easing: h.transitions.easing.sharp,
                  duration: h.transitions.duration.enteringScreen
                }),
                p: h.spacing(
                  a ? 4 : 9,
                  a ? 12 : 2,
          ...
          /* @__PURE__ */ E(
            Gt,
            {
              sx: (h) => ({
                ...
                left: a ? 0 : "-100%",
                opacity: a ? 1 : 0,
                transition: h.transitions.create(["left", "opacity"], {
                  easing: h.transitions.easing.sharp,
                  duration: h.transitions.duration.enteringScreen
                }),
                px: "24px",
                ...
                background: h.palette.mode === "light" ? "rgba(255,255,255,0.6)" : ln(h.palette.background.paper, 0.1),
...
function xu() {
  const e = Le("(prefers-color-scheme: dark)"), r = (localStorage.getItem("prefers-dark-mode") != null ? localStorage.getItem("prefers-dark-mode") === "true" : null) ?? e, [i, a] = M(r ? "dark" : "light");
  z(() => {
...
const Bu = ({ children: e, maxSnack: t = 3, autoHideDuration: r = 3500 }) => /* @__PURE__ */ n(
  hs,
  {
    maxSnack: t,
    autoHideDuration: r,
  ...
  const [r, i] = M(void 0), [a, o] = M(), [s, l] = M(), [c, d] = M(!0), [A, u] = M(!0), [h, p] = M(!1), [f, g] = M(), [m, v] = M();
  z(() => {
    if (e)
      try {
        const F = Se(e);
...
function Iu({
  ...
  const i = w((l, c, d) => {
    ...
    const p = Ke(e), f = Qt(p, l), g = [];
    return c && Object.entries(c).filter(([m, v]) => !!v).forEach(([m, v]) => {
      const [b, x] = v;
      g.push(oo(m, b, pn(x, p)));
    }), c && d && A && Object.entries(c).forEach(([m, v]) => {
      m !== d && g.push(io(m, "asc"));
    }), d && A && g.push(io(d, A)), u && g.push(cl(u)), h && g.push(dl(h)), ao(f, ...g);
  }, [e]), o = w((l, c, d) => {
    if (!e)
      throw Error("useFirestoreDataSource Firebase not initialised");
    const A = Ke(e);
    ...
    return Promise.all(u).then((h) => h.filter((p) => p !== void 0 && p.values));
  }, [o]);
  return {
    fetchCollection: w(({
      path: l,
      ...
      if (h)
        return s(l, h, c);
      console.debug("Fetching collection", l, A, d, u, p, f);
      const g = a(l, d, p, f, u, A);
    ...
    listenCollection: w(({
      ...
      console.debug("Listening collection", l, A, d, u, p, f);
      const v = a(l, d, p, f, u, A);
      if (h)
        return s(l, h, c).then(g).catch((x) => {
          m && m(x);
        }), () => {
        };
      const b = ke({
    ...
    saveEntity: w(({
      ...
      const h = Ke(e), f = ke({
        ...
        entityId: c,
        fields: r
      }).properties, g = Qt(h, l), m = pn(d, h), v = Hc(
        {
          inputValues: m,
          properties: f,
          status: u,
...
function Fu({
  ...
  const h = he(), p = w(async () => {
    if (e.initialLoading)
      return;
    if (!e.user) {
      h.current = void 0, s(!1), A(!1);
      return;
    }
    const f = e.user;
    if (t instanceof Function && f && !Ae(h.current, f)) {
      s(!0);
      try {
        await t({
          user: f,
...
function Ou({
  ...
  const A = kr(), [u, h] = M(!1), [p, f] = M(!1), g = r.map((y) => typeof y == "object" ? y.provider : y), m = w(() => {
...
function Vu({
  ...
  const o = he(null), [s, l] = M(), [c, d] = M(), [A, u] = M(), h = c === void 0, p = c && c.includes("password"), f = c && !c.includes("password") && c.length > 0, g = c && !c.includes("password");
  z(() => {
    (p || g) && o.current && o.current.focus();
  }, [p, g]), z(() => {
    if (!document)
      return;
    const C = (S) => {
  ...
  const x = () => {
    ...
    C.preventDefault(), h ? m() : p ? v() : g && b();
  }, k = g ? "No user found with that email. Pick a password to create a new account" : p ? "Please enter your password" : "Please enter your email", I = g ? "Create account" : p ? "Login" : "Ok";
...
export {
  ...
  Lc as StorageThumbnailInternal,
