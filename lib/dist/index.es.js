...
const Td = function({
  ...
  }, [t, u, a]), [m, v] = Q.useState(p), [b, x] = Q.useState(!1), [y, k] = Q.useState(), [I, C] = M(a?.values ?? g), [S, D] = M(I), P = (O) => {
    D(O), c && c(O);
  }, R = ie(() => ke({
    collection: i,
    path: r,
...
function Lr({
  ...
  const A = Be(), u = Oe(A.breakpoints.up("md")), h = Boolean(c), p = Boolean(l), f = Boolean(d), [g, m] = Q.useState(null), v = w((C) => {
...
function jA({
  ...
  const i = re(), a = Ve(), s = Ie().resolveAliasesFrom(t), l = Q.useMemo(() => ke({
    ...
    c.current = R;
    const L = await C(R);
    d.current = L, p(void 0), $ && (I(R, L, l, s, r), k());
  }, [l, I, r, C, m, k, s]);
  z(() => {
...
function NA({
  ...
  const c = re(), d = Ft(), A = Be(), u = Oe(A.breakpoints.up("md")), h = s.selectedEntities, p = Or(e, d, tt(o), null) && t && (u ? /* @__PURE__ */ E(
    ae,
    {
      onClick: t,
...
const nu = Q.memo(
  function({
    ...
    const A = Be(), u = Oe(A.breakpoints.up("lg")), h = he(!u), p = typeof l == "number" ? `${l}px` : l ?? dn, f = Ve(), g = Yr(), m = At(), v = rt(), b = re(), x = Ft(), [y, k] = M(a ? "copy" : r ? "existing" : "new"), [I, C] = M(r), S = he(void 0), D = S.current, P = (o.subcollections ?? []).filter((Y) => !Y.hideFromNavigation), R = P?.length ?? 0, $ = o.views, L = $?.length ?? 0, K = L > 0 || R > 0, V = _i(o), W = !i && u && V, [O, F] = Q.useState(W ? 0 : -1), G = O === -1 || u, {
      entity: U,
      dataLoading: j,
      dataLoadingError: se
    } = Cr({
...
const hu = function({
  ...
  function(t) {
    const {
      ...
      Drawer: s
    } = t, l = Be(), c = Oe(l.breakpoints.up("md")), d = Ie(), A = mu(), [u, h] = Q.useState(!1), p = s || gu, f = w(() => {
      h(!1);
    }, []);
    return /* @__PURE__ */ E(B, { sx: {
      display: "flex",
