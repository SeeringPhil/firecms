 ...
 * @category Models
 */
export type PermissionsBuilder<EC extends EntityCollection = EntityCollection, UserType extends User = User, M extends any = InferCollectionType<EC>> = (({ pathSegments, user, collection, authController }: PermissionsBuilderProps<EC, UserType, M>) => Permissions);
